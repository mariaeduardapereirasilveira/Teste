...
3. Elabore um algoritmo que solicite ao usuário um número. O algoritmo deverá informar se o
...
(JavaScript - PARTE 2), temos a explicação do comando de resto da divisão. J
...
aconteceu.
7. Elabore um algoritmo que solicita ao usuário o nome e a idade de uma pessoa. O programa
deverá imprimir na tela o nome da pessoa e se ela é maior ou menor de idade. Lembrando:
menor de idade tem menos de 18 anos e maior de idade tem 18 anos ou mais.

8. Elabore um algoritmo que solicita ao usuário um número inteiro que representa uma senha.
...
sexo de uma pessoa (utilize M para masculino e F para femino). Por exemplo, a altura pode
ter valor 1.78, ou seja, um metro e setenta e oito centímetros. A partir dessas duas
informações, o algoritmo deve calcular e escrever o peso ideal da pessoa, considerando as
seguintes fórmulas:
...
depois de 1990. A taxa incide sobre o valor de tabela do carro. Elabore um algoritmo que
